...
const Skils = () => {
  ...
  return (
    <div className="min-h-[60vh]  flex justify-center items-center flex-col">
      <h2 className='sm:text-4xl text-2xl font-bold font-madimi text-center my-9 sm:mb-[100px] text-white'><span className='text-teal-500 '>MERN </span> STACK DEVELOPER</h2>
